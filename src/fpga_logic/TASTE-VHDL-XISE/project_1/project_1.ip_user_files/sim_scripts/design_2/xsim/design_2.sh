...
#
# Generated by Vivado on Tue Nov 24 13:05:48 CET 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot design_2 xil_defaultlib.design_2 -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/jannis/Programs/Vivado/Vivado/2018.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
